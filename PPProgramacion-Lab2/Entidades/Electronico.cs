...
namespace Entidades
{
    public class Electronico : Producto
    {
        ...
        public Electronico(int codigo, string marca, string nombre, float precio, int cantidad) : base(codigo, marca, nombre, precio, cantidad)
        {
        ...
        public string Caracteristicas { get { return "Solo Marcas Originales Kasio, Apless,Sansumgs"; } }
        /// <summary>
        /// Devuelve la categoria del articulo.
        /// </summary>
        public override Categoria CategoriaP { get { return Categoria.Electronico; } }
        ...
        public override string DatosDeProducto()
        {
            ...
            sb.Append($"Tamaño de bebida {this.Caracteristicas.ToString()}");
